...
public interface CursoRepository extends CrudRepository<CursoModel,Integer>{
    ...
    @Query(value = "select new labes.facomp.ufpa.br.meuegresso.dto.grafico.CursosGraficoDTO(c.nome curso, count(et) quantidade) from curso c inner join egresso_titulacao et on et.curso = c.id group by c.nome")
