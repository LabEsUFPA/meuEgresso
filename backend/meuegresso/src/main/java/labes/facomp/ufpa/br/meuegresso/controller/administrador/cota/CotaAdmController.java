package labes.facomp.ufpa.br.meuegresso.controller.administrador.cota;
...
@RequestMapping("/administrador/cota")
public class CotaAdmController {
	...
	/**
	 * Endpoint responsavel por deletar a cota do egresso.
	 *
	 * @param id Integer corresponde a Id de uma cota.
	 * @return Mensagem de confirmacao.
	 * @author Alfredo Gabriel
