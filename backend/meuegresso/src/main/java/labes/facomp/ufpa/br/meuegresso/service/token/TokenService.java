package labes.facomp.ufpa.br.meuegresso.service.token;
...
/**
 * Serviço responsável criar o token de autenticação do usuário após o mesmo ser registrado no contexto de segurança.
 *
