...
public interface EgressoService {
   ...
   * Metodo responsavel por atualizar informacoes do egresso no banco de dados.
   * 
   * @param egressoEmpresa Dados da emprego egresso
   * @return Dados após serem atualizados no banco de dados.
   * @author Pedro Inácio
   * @since 16/04/2023
   */
  public EgressoEmpresaModel updateEgressoEmpresa(EgressoEmpresaModel egressoEmpresa);
  ...
  /**
   * Metodo responsavel por deletar informacoes da contribuicao egresso no banco
   * de dados.
   * 
  ...
  /**
   * Metodo responsavel por deletar informacoes da colacao(titulacao) do egresso
   * no banco
   * de dados.
   * 
