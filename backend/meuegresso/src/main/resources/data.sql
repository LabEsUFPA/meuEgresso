...
INSERT INTO usuario (id_usuario,ativo,created_date,last_modified_date,email,matricula_usuario,nome_usuario,senha_usuario,login_usuario) VALUES (1,true,'2023-04-22 14:34:40.702','2023-04-22 14:34:40.702','admin@admin.com','123456789','ADMIN ADMIN','{bcrypt}$2a$10$vh9/MkL4XQyd.fqkQdnWSelTUxPBpDb6qL5W2uWLxLUN0JR9vwRZm','ADMIN') ON CONFLICT DO NOTHING;

INSERT INTO usuario (id_usuario,ativo,created_date,last_modified_date,email,matricula_usuario,nome_usuario,senha_usuario,login_usuario) VALUES (2,true,'2023-04-22 14:35:09.149','2023-04-22 14:35:09.149','secretario@secretario.com','3131313','SECRETARIO SECRETARIO','{bcrypt}$2a$10$biZwxymZqQDevuqWzB/wCe0jfC6Idr.SJRYO9oXBFPuusp9oA9hAy','SECRETARIO') ON CONFLICT DO NOTHING;
