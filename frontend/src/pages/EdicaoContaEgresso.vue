    ...
    >
      ...
      <div class="w-full flex items-center justify-center bg-neutral-100 mb-10">
        <div v-if="!submitSuccess"
          ...
          <InvalidInsert :text="errorText" :show-alert="error" />
          ...
          <div class="mb-8">
            ...
            <div class="flex flex-col gap-y-5 mb-4 items-center">
              ...
              <CustomInput name="email" type="email" label="E-mail" :required="true" :icon-path="mdiEmail" />
              <CustomInput name="confirmationEmail" type="email" label="Confirmar e-mail"
                error-message="Os e-mails informados são diferentes" :required="true" :icon-path="mdiEmail" />
              <CustomInput name="password" type="password" label="Nova senha" :required="true" :icon-path="mdiLock" />
              <CustomInput name="confirmationPassword" type="password" label="Confirmar senha"
                error-message="As senhas informadas são diferentes" :required="true" :icon-path="mdiLock" />
            </div>
          </div>
      ...
      <div class="h-full flex justify-center items-center">
        <div class="w-1/2">
          <div class="text-green-500 text-center mb-3">
            <SvgIcon type="mdi" size="100" class="inline" :path="mdiCheckCircle" />
          </div>
