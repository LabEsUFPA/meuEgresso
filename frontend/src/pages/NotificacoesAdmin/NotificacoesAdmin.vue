<template>
  <div class="flex flex-col">
    ...
    <div class="flex justify-center">
      <div class="flex flex-col gap-4 sm:gap-6 w-[960px] bg-white  rounded-br-2xl p-6 sm:p-6 mx-4 sm:mx-6 items-center">
    ...
    <div class="flex flex-col">
      <div class="flex justify-center">
        <div class="flex flex-col gap-4 sm:gap-6 w-[960px] bg-white p-6 sm:p-8 mx-4 sm:mx-6 items-center">
          <div class="flex flex-col sm:flex-row w-full items-start gap-4 sm:gap-8">
            <div class="flex gap-4 text-cyan-800 items-center">
